...
public class CardControllerAdapter {
    ...
    public RestResponse<Integer> createCard(final HttpServletRequest httpServletRequest, @RequestBody CardRest request )throws ExecutionException, InterruptedException{
